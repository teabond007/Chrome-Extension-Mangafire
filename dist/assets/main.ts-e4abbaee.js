var V=Object.defineProperty;var X=(r,e,t)=>e in r?V(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var $=(r,e,t)=>(X(r,typeof e!="symbol"?e+"":e,t),t);import{o as y,c as x,a as m,n as T,w as C,b as z,t as R,d as b,F as W,r as Y,e as G,f as Q,g as A}from"./runtime-dom.esm-bundler-1e3063a8.js";import{_ as q}from"./_plugin-vue_export-helper-c27b6911.js";const J={Reading:"#4ade80",Completed:"#60a5fa","Plan to Read":"#fbbf24","On-Hold":"#f97316","On Hold":"#f97316",Dropped:"#ef4444","Re-reading":"#a855f7",HasHistory:"#9ca3af"};const Z=["data-entry-id"],ee=["title"],te=["title"],re=["title"],ae={__name:"QuickActions",props:{entry:{type:Object,required:!0},adapter:{type:Object,required:!0},callbacks:{type:Object,default:()=>({})}},emits:["action"],setup(r,{emit:e}){const t=r,o=e,a=b(()=>(parseFloat(t.entry.lastReadChapter)||0)>0),n=b(()=>t.adapter.unitName==="episode"?"Ep.":"Ch."),i=b(()=>{const d=parseFloat(t.entry.lastReadChapter)||0;return Math.floor(d)+1}),s=b(()=>a.value?`Continue ${n.value} ${i.value}`:`Start Reading ${n.value} 1`),l=b(()=>{var d;return((d=t.entry.personalData)==null?void 0:d.rating)||0}),c=b(()=>{const d={reading:"#4ade80",completed:"#60a5fa","plan to read":"#fbbf24",planning:"#fbbf24","on-hold":"#f97316","on hold":"#f97316",dropped:"#ef4444","re-reading":"#a855f7",rereading:"#a855f7"},h=(t.entry.status||"").toLowerCase().trim();return d[h]||"rgba(255,255,255,0.3)"}),u=(d,h)=>{t.callbacks[d]&&t.callbacks[d](t.entry,h==null?void 0:h.currentTarget),o("action",{action:d,entry:t.entry,target:h==null?void 0:h.currentTarget})};return(d,h)=>(y(),x("div",{class:"bmh-quick-tooltip","data-entry-id":r.entry.slug||r.entry.id||""},[m("button",{class:T(["bmh-tt-btn bmh-tt-continue",{"bmh-btn-disabled":!a.value}]),onClick:h[0]||(h[0]=C(g=>u("continue",g),["stop","prevent"])),title:s.value}," ▶ ",10,ee),m("button",{class:"bmh-tt-btn bmh-tt-status",onClick:h[1]||(h[1]=C(g=>u("status",g),["stop","prevent"])),title:r.entry.status||"Set Status",style:z({"--status-color":c.value})},[m("span",{class:"bmh-tt-status-dot",style:z({background:c.value})},null,4)],12,te),m("button",{class:"bmh-tt-btn bmh-tt-rating",onClick:h[2]||(h[2]=C(g=>u("rating",g),["stop","prevent"])),title:`Rating: ${l.value}/10`},R(l.value>0?l.value:"★"),9,re),m("button",{class:"bmh-tt-btn bmh-tt-info",onClick:h[3]||(h[3]=C(g=>u("details",g),["stop","prevent"])),title:"View Details"}," ℹ ")],8,Z))}},oe=q(ae,[["__scopeId","data-v-5874bd77"]]);const ne={class:"bmh-picker-options"},se=["onClick"],ie={__name:"StatusPicker",props:{entry:{type:Object,required:!0},customStatuses:{type:Array,default:()=>[]},onSelect:{type:Function,default:null}},emits:["select"],setup(r,{emit:e}){const t=r,o=e,a=[{name:"Reading",color:"#4ade80"},{name:"Completed",color:"#60a5fa"},{name:"Plan to Read",color:"#fbbf24"},{name:"On-Hold",color:"#f97316"},{name:"Dropped",color:"#ef4444"},{name:"Re-reading",color:"#a855f7"}],n=b(()=>[...a,...t.customStatuses]),i=s=>{t.onSelect&&t.onSelect(s,t.entry),o("select",s)};return(s,l)=>(y(),x("div",{class:"bmh-status-picker",onClick:l[0]||(l[0]=C(()=>{},["stop"]))},[l[1]||(l[1]=m("div",{class:"bmh-picker-header"},"Change Status",-1)),m("div",ne,[(y(!0),x(W,null,Y(n.value,c=>(y(),x("button",{key:c.name,class:T(["bmh-picker-option",{active:r.entry.status===c.name}]),onClick:u=>i(c.name)},[m("span",{class:"bmh-picker-dot",style:z({background:c.color})},null,4),G(" "+R(c.name),1)],10,se))),128))])]))}},le=q(ie,[["__scopeId","data-v-40c15120"]]);const ce={class:"bmh-rating-grid"},de=["onMouseenter","onClick"],ue={__name:"RatingPicker",props:{entry:{type:Object,required:!0},onSelect:{type:Function,default:null}},emits:["select"],setup(r,{emit:e}){const t=r,o=e,a=Q(0),n=b(()=>{var s;return((s=t.entry.personalData)==null?void 0:s.rating)||0}),i=s=>{t.onSelect&&t.onSelect(s,t.entry),o("select",s)};return(s,l)=>(y(),x("div",{class:"bmh-rating-picker",onClick:l[2]||(l[2]=C(()=>{},["stop"]))},[l[3]||(l[3]=m("div",{class:"bmh-picker-header"},"Rate (1-10)",-1)),m("div",ce,[(y(),x(W,null,Y(10,c=>m("button",{key:c,class:T(["bmh-rating-num",{active:c===n.value,hovered:c<=a.value}]),onMouseenter:u=>a.value=c,onMouseleave:l[0]||(l[0]=u=>a.value=0),onClick:u=>i(c)},R(c),43,de)),64))]),m("button",{class:"bmh-rating-clear",onClick:l[1]||(l[1]=c=>i(0))},"Clear")]))}},he=q(ue,[["__scopeId","data-v-cab7d0ad"]]);const pe={__name:"StatusBadge",props:{text:{type:String,required:!0},type:{type:String,default:"progress"},position:{type:Object,default:()=>({})}},setup(r){const e=r,t=b(()=>{const o={...e.position};return Object.keys(o).length?o:e.type==="new"?{top:"4px",right:"4px"}:{bottom:"4px",left:"4px"}});return(o,a)=>(y(),x("div",{class:T(["bmh-badge",[`bmh-badge-${r.type}`]]),style:z(t.value)},R(r.text),7))}},me=q(pe,[["__scopeId","data-v-7c094370"]]);const ge={class:"bmh-as-speed-control"},be=["value"],fe={class:"bmh-as-speed-value"},ye={__name:"ReaderControls",props:{initialSpeed:{type:Number,default:50},isRunning:{type:Boolean,default:!1}},emits:["toggle","speed-change"],setup(r,{emit:e}){const t=r,o=e,a=Q(t.initialSpeed),n=()=>{o("toggle")},i=s=>{const l=parseInt(s.target.value);a.value=l,o("speed-change",l)};return(s,l)=>(y(),x("div",{class:"bmh-autoscroll-panel",onClick:l[0]||(l[0]=C(()=>{},["stop"]))},[m("button",{class:T(["bmh-as-toggle",{active:r.isRunning}]),type:"button",onClick:n},R(r.isRunning?"⏸ Stop":"▶ Start"),3),m("div",ge,[l[1]||(l[1]=m("span",{class:"bmh-as-label"},"Speed:",-1)),m("input",{type:"range",class:"bmh-as-speed",min:"20",max:"200",value:a.value,onInput:i},null,40,be),m("span",fe,R(a.value),1)])]))}},xe=q(ye,[["__scopeId","data-v-034a957b"]]);class p{static mountStatusPicker(e,t,o,a){document.querySelectorAll(".bmh-vue-picker-container").forEach(g=>g.remove());const n=document.createElement("div");n.className="bmh-vue-picker-container bmh-vue-status-picker",document.body.appendChild(n);const i=n.attachShadow({mode:"open"}),s=document.createElement("div");i.appendChild(s);const l=document.createElement("style");l.textContent=`
            .bmh-status-picker {
