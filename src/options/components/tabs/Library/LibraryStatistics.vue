<template>
    <div 
        ...
        ref="root"
        class="stats-dashboard-card standard-card" 
...
@media (max-width: 768px) {
    .stats-dashboard-card .stats-grid-compact .stats-row {
        &.stats-row-main {
            justify-content: center;
            ...
            .stat-item-compact {
                ...
                .stat-value-large { font-size: 1.3rem; }
            }
        }
        &.stats-row-secondary { grid-template-columns: 1fr; }
        &.stats-row-charts { grid-template-columns: 1fr; }
    }
}
</style>
